/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57f70ff34eb25534f72cf0cbeaca6765)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UNIVERSE_ID" | "ROBLOX_API_KEY">> {}
}
